...
@section('content')
    ...
    <div class="result_box">
        ...
        <div class="complete_text"><h3>Results</h3></div>
...
@section('script')
    <script>
        ...
        //     },
        // ];
        let questions = '<?php echo addslashes(JSON_encode($questions));?>';
        ...
        function showResult() {
            ...
            const questionsText = result_box.querySelector(".questionsText");
            let questionText = "";
            ...
            if ((100 * userScore) / 3 > 59) { // if user scored more than 3
                ...
                let scoreTag = '<center><span style="color:red">Failed 😐</span></center>';
                scoreText.innerHTML = scoreTag;
                questionsText.innerHTML = questionText+scoreTag;
            }
        }
        ...
        function queCounter(index) {
            ...
            let totalQueCounTag = '<span><p>' + index + '</p> of <p>' + questions.length + '</p> Questions &nbsp;&nbsp; <a href="{{ route('home') }}" style=" text-decoration: none; color:white; background-color:red; padding-botton:25px;">RESET</a></span> ';
